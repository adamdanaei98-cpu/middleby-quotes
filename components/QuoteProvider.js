...
export function QuoteProvider({ children }) {
  ...
  return (
    <QuoteContext.Provider value={{ cats, setCats, sels, setSels, companies, setCompanies, customers, setCustomers, loading, mode, setMode, ci, setCi, approval, setApproval, terms, setTerms, navLogo, setNavLogo, tots, gt, loadQuote }}>
      {children}
